...
func(this*ArticleController)HandleAddArticle(){
	...
	//给插入对象赋值
	article.Title = articleName                           //name
	article.Content = content                             //wenzhang
	article.Img = "/static/img/"+fileName+ext             //tupian
	...
	article.ArticleType = &articleType                    //leixing
	//插入数据
	_,err = o.Insert(&article)                            //insert
	if err != nil {
